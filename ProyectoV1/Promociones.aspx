...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <p></p><p></p><p></p><p>
    <center> <asp:Image ID="Image3" runat="server" ImageUrl="~/Imagenes/promotion-flag.png" /></center> 
    <p>
        <center> <asp:Image ID="Image4" runat="server" ImageUrl="~/Imagenes/restaurantlaterraza.jpg" /></center> 
    </p>
...
<ul>
    ...
    <li>Paseo en Lancha
    <li>Paseo en banana o bestia segun de su elección
    <li>Show de marimba
