namespace Hotel.Datos
{
    ...
    public class TipoClienteDa
    {
        ...
        public int CrearTipoCliente(GEN_TipoCliente tipoCliente)
        {
            ...
            try
            {
                _HotelEntities.GEN_TipoCliente.AddObject(tipoCliente);
        ...
        public GEN_TipoCliente ObtenerTipoCliente(int idTipoCliente)
        {
            ...
            try
            {
                retorno = _HotelEntities.GEN_TipoCliente.Single(tc => tc.IdTipoCliente == idTipoCliente);
                _HotelEntities.Dispose();
                return retorno;
            }
            catch (Exception)
        ...
        public List<GEN_TipoCliente> ObtenerTiposClientes()
        {
            ...
            try
            {
                listaRetorno = _HotelEntities.GEN_TipoCliente.ToList();
                _HotelEntities.Dispose();
                return listaRetorno;
            }
            catch (Exception)
        ...
        public int ActualizarTipoCliente(GEN_TipoCliente tipoCliente)
        {
            ...
            try
            {
                _HotelEntities.GEN_TipoCliente.Attach(tipoCliente);
                _HotelEntities.ObjectStateManager.ChangeObjectState(tipoCliente, EntityState.Modified);
                idRetorno = _HotelEntities.SaveChanges();
                _HotelEntities.Dispose();
                return idRetorno;
            }
        ...
        public int EliminarTipoCliente(int idTipoCliente)
        {
            ...
            try
            {
                ...
                _HotelEntities.TryGetObjectByKey(new EntityKey("SisResEntities.GEN_TipoCliente", "IdTipoCliente", idTipoCliente), out objetoEliminar);
